...
<html lang="en">
   <head>
      ...
      <title>Vishnu Visitors | Guest Pass Printing Page</title>
      <!-- Bootstrap core CSS -->
                  ...
                  <div class="container" style="width: 380px;">
                     <div class="row">
                        ...
                        <div class="col-sm-5" style="padding-left: 0;">
                           <img style="border-radius:10px;margin-bottom: 10px;" <?php echo 'src="upload/guests/'.$img.'"';?> width="160px" height="120px">
